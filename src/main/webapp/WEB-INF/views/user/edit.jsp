    ...
    <div class="profile-card">
        ...
        <form action="/user/edit" method="post" class="edit-form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="${user.name}" class="form-control" minlength="2" maxlength="20" required>
                <small class="form-text">2~20자 이내로 입력해주세요</small>
            </div>
            <div class="form-group">
                <label>가입 유형</label>
                <div class="provider-info">
                    <span class="provider-badge ${user.providerType}">
                        <i class="fas ${user.providerIconClass}"></i> ${user.providerDisplayName} 계정
                    </span>
                </div>
            </div>
